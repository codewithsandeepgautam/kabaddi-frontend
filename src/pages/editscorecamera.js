      ...
      <Layout>
         <div className="container">
            ...
            <div className='text-center p-4'>
               ...
               <button class="py-2 px-6 bg-[#13215c] text-white  rounded-[4px] m-1 focus:outline-none"><Link to="/editscoreopposite">Opposite View</Link></button>
            </div>
            <div className='lg:w-[50%] md:w-[50%] w-full bg-white shadow-md rounded-[4px] mb-4'>
...
export default EditScoreCamera;